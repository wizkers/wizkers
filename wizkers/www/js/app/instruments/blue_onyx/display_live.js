        ...
        render: function () {
            ...
            if (this.display_map) {
                ...
                if (this.map != null) {
                    ...
                    // - Last, remove 10 pixels to account for the margin at the bottom of the map.
                    // ... now do the equation
                    var self = this;
                    var rsc = function () {
                        // We want the chart to be 20% of the screen
                        if (self.display_graph) {
                            self.$('.geigerchart').height(window.innerHeight * 0.2);
