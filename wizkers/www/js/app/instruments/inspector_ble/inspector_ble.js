...
/**
 * A Medcom Inspector BLE instrument. Only works on Chrome apps on
 * Chromebooks, and on Cordova too.
 * 
 * It is identical to the Blue Onyx (so far) with the exception of the
 * backend driver, of course.
 *
...
define(function (require) {
    ...
    return function () {
        ...
        this.getBackendDriver = function (arg, callback) {
            require(['app/instruments/inspector_ble/driver_backend'], function (driver) {
