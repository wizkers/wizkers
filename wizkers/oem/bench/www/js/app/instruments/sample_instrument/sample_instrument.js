...
/**
 * A Dummy instrument. Just connects to a dummy backend for testing.
 * Gets a dummy stream of dummy data between 0 and 100 every second.
 * 
...
define(function (require) {
    ...
    return function () {
        ...
        this.getLiveDisplay = function (arg, callback) {
            require(['app/instruments/sample_instrument/display_live'], function (view) {
        ...
        this.getNumDisplay = function (arg, callback) {
            require(['app/instruments/sample_instrument/display_numeric'], function (view) {
        ...
        this.getDiagDisplay = function (arg, callback) {
            require(['app/instruments/sample_instrument/display_diag'], function (view) {
        ...
        this.getBackendDriver = function (arg, callback) {
            require(['app/instruments/sample_instrument/driver_backend'], function (driver) {
        ...
        this.getLogView = function (arg, callback) {
            require(['app/instruments/sample_instrument/display_log'], function (view) {
                callback(new view(arg));
            });
        }
        ...
        this.getWizkersSettings = function(arg, callback) {
            require(['app/instruments/sample_instrument/settings_wizkers'], function(view) {
                callback(new view(arg));
            });
        };
