...
define(function(require) {
    ...
    var driver_frontend = require('app/instruments/sark110/driver_frontend');
    ...
    return  function() {
        ...
        this.getLiveDisplay = function(arg, callback) {
            require(['app/instruments/sark110/display_live'], function(view) {
        ...
        this.getNumDisplay = function(arg, callback) {
            require(['app/instruments/sark110/display_numeric'], function(view) {
        ...
        this.getDiagDisplay = function(arg, callback) {
            require(['app/instruments/sark110/display_diag'], function(view) {
                callback(new view(arg));
            });
        };
        ...
        this.getBackendDriver = function(arg, callback) {
            require(['app/instruments/sark110/driver_backend'], function(view) {
                callback(new view(arg));
            });
        };
        ...
        this.getLogView = function(arg, callback) {
            require(['app/instruments/sark110/display_log'], function(view) {
                callback(new view(arg));
            });
        }
